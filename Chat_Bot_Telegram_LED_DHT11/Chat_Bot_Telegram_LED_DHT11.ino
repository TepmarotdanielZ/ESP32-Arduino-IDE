...
#define WIFI_SSID "Sonin KH"       /* TYPE YOUR WIFI NAME */  
#define WIFI_PASSWORD "77771112"   /* TYPE YOUR WIFI PASSWORD */ 
...
const int led1Pin = 5; /* PIN FOR LED1 */
const int led2Pin = 6; /* PIN FOR LED2 */
