...
unsigned long bot_lasttime; /* LAST TIME MESSAGES' SCAN HAS BEEN DONES */ 
...
void setup()
{
  Serial.begin(115200);
  Serial.println();
  pinMode(led1Pin, OUTPUT); /* INITIALIZE DIGITAL LEDPIN1 AS AN OUTPUT. */ 
  pinMode(led2Pin, OUTPUT); /* INITIALIZE DIGITAL LEDPIN2 AS AN OUTPUT. */ 
  delay(10);
